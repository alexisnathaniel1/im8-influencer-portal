...
export default function BulkUploadClient({ canViewRates }: { canViewRates: boolean }) {
            ...
            <table className="w-full text-[12px]">
              <thead className="bg-im8-offwhite sticky top-0 z-10">
                <tr className="text-left text-[11px] text-im8-muted uppercase tracking-[0.05em]">
                  ...
                  {canViewRates && <th className="px-3 py-2 font-semibold text-right">Monthly</th>}
                  {canViewRates && <th className="px-3 py-2 font-semibold">Months</th>}
