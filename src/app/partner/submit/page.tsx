...
function SubmitForm() {
  ...
  async function handleUpload() {
    ...
    try {
      ...
      setProgress(100);
      router.push(prefillBriefId ? `/partner/briefs/${prefillBriefId}` : "/partner/submissions");
    } catch (err) {
  ...
  return (
    <div className="max-w-xl animate-fade-in">
      <div className="mb-6">
        <Link href="/partner" className="text-sm text-im8-red hover:underline mb-1 inline-block">
          ← Back
        </Link>
